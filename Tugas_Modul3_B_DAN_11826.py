...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1841</h1>", unsafe_allow_html=True)
...
model_directory = r'C:\Users\LENOVO\Documents\Tugas3_B_11826'
